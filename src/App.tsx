...
const EnviarAuditoriaIndividual = lazy(() => import("./pages/EnviarAuditoriaIndividual"));
...
function AppRoutes() {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/auditoria/enviar-individual" element={<EnviarAuditoriaIndividual />} />
  ...
  <ThemeProvider attribute="class" defaultTheme="light" enableSystem={false} disableTransitionOnChange>
    <QueryClientProvider client={queryClient}>
      <TooltipProvider>
        <Toaster />
        <Sonner />
        <CelebracaoVenda supabase={supabase} sistema="Pingolead" somUrl="/sons/venda-celebracao.mp3" />
        <BrowserRouter>
          <AuthProvider>
            <AppRoutes />
          </AuthProvider>
